  ...
  return (
    <div className="social-cards-wrapper">
      <div className="social-cards">
        <a href="https://www.facebook.com/share/1H2w1YJFHi/" target="_blank" rel="noopener noreferrer" className="social-card-container facebook-card">
          ...
          <p className="stats">Join us</p>
        </a>
        <a href="https://www.facebook.com/share/1H2w1YJFHi/" target="_blank" rel="noopener noreferrer" className="social-card-container instagram-card">
          <div className="icon-container">
